    ...
    <header class="primary-header flex">
        ...
        <nav>
            <ul class="primary-navigation flex">
                ...
                <li><a href="index.php?action=private-admin" class="ff-sans-cond uppercase text-white letter-spacing-2">PrivateA</a></li>
               

                <li><a href="index.php?action=private-user" class="ff-sans-cond uppercase text-white letter-spacing-2">PrivateU</a></li>
